...
object Mandelbrot {
  ...
  def each_point(width:Int, height:Int, func: (Int, Int, Int) => Unit):Unit = {
    val rs = 3.0/width
    val is = 2.0/height
  ...
  // More Procedural
  def foreach_point(width:Int, height:Int, func: (Int, Int, Int) => Unit):Unit = {
    var r = -2.0
    var i = -1.0
